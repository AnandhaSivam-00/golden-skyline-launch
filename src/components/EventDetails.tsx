  ...
  return (
    <div className="my-12 max-w-3xl mx-auto px-4">
      <div className="text-center mb-10 animate-fade-in">
        ...
        <h3 className="text-event-gold font-serif text-2xl md:text-3xl lg:text-4xl mt-6 animate-fade-in-right" style={{ animationDelay: '0.3s' }}>
      ...
      <div className="text-center mb-10 animate-fade-in" style={{ animationDelay: '0.5s' }}>
        ...
        <h2 className="text-event-gold font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-2 gold-gradient bg-clip-text text-transparent animate-shine">
          Dr K Thyagarajah
        </h2>
      ...
      <div className="bg-black/20 backdrop-blur-sm p-6 rounded-lg border border-event-gold/20 shadow-lg animate-fade-in gold-gradient bg-clip-text" style={{ animationDelay: '0.7s' }}>
